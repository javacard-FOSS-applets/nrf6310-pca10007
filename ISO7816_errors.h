...
static struct spec_err {
	...
	//{0x61--, "Response bytes still available"}, 
	...
	//{0x62CX, "Counter with value x (command dependent)"}, 
	{0x62F1, "Wrong C-MAC"}, 
	...
	//{0x63CX, "The counter has reached the value 'x' (0 = x = 15) (command dependent)."}, 
	...
	//{0x67--, " "}, 
	{0x6700, "Wrong length"}, 
	//{0x67XX, "length incorrect (procedure)(ISO 7816-3)"}, 
	...
	//{0x920x, "Writing to EEPROM successful after 'x' attempts."}, 
	...
	//{0x6BXX, "Reference incorrect (procedure byte), (ISO 7816-3)"}, 
	//{0x6C--, "Wrong length Le"}, 
	{0x6C00, "Incorrect P3 length."}, 
	//{0x6CXX, "Bad length value in Le; 'xx' is the correct exact Le"}, 
	{0x6d00, "Invalid instruction"}, 
	//{0x6D--, " "}, 
	{0x6D00, "Instruction code not supported or invalid"}, 
	//{0x6DXX, "Instruction code not programmed or invalid (procedure byte), (ISO 7816-3)"}, 
	{0x6e00, "Invalid class"}, 
	//{0x6E--, " "}, 
	{0x6E00, "Class not supported"}, 
	//{0x6EXX, "Instruction class not supported (procedure byte), (ISO 7816-3)"}, 
	//{0x6F--, "Internal exception"}, 
	{0x6F00, "Command aborted - more exact diagnosis not possible (e.g., operating system error)."}, 
	{0x6FFF, "Card dead (overuse, …)"}, 
	//{0x6FXX, "No precise diagnosis (procedure byte), (ISO 7816-3)"}, 
	//{0x9---, " "}, 
	...
	//{0x9FXX, "Command successfully executed; 'xx' bytes of data are available and can be requested using GET RESPONSE."}, 
