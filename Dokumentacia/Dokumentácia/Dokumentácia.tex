...
\section{ISO7816 debugger}
	...
	\begin{itemize}
		...
		\item prehľadávanie dostupných inštrukcií v danom súbore,
		...
		\item kontinálny príjem alebo posielanie dát na UART sérovej linke,
		\item zavolanie metódy, ktorá zavolá testovaciu rutinu appletu na karte.
	\end{itemize}
