...
ANT protokol komunikuje vo vyhradených časových intervaloch \ref{f:reverse_send}. Takisto umožnuje obojsmernú komunikáciu. Komunikácia smerom naspäť, od Slave zariadenia k Mastrovi, je možná iba vo vyhradenom krátkom časovom úseku. Pokiaľ výpočet nezbehne počas daného krátkeho časového úseku, je nutné dáta poslať v niektorých daľších časových úsekoch.
...
Z ATR správy okrem iných vecí, sa dá identifikovať preferovaný spôsob a parametre komunikácie. Boli implementované dve najpoužívanejšie formy komunikácie štandardu ISO7816:
	\begin{itemize}
...
Počas vypracovania záverečnej práce boli vyrobené dve dosky plošných spojov. Ich zapojenie a funkcie sú opísané v nasledujúcich kapitolách.

	\subsection{Test board pre ISO7816}
	
	Prvá navrhnutá a realizovaná doska, slúži v prvom rade na odladenie komunikácie pomocou UART sériovej linky so štandardom ISO7816 a na pozorovanie správania sa komunikácie s rôznym spôsobom pripojenia sériovej linky ku kryptoelementu.
	
	Konektor vľavo slúži na pripojenie pinov procesora. Na konektor vprava sa pripojuje samotny kryptoelement.
