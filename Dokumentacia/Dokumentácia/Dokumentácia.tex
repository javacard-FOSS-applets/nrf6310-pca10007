...
\subsection{Master}
	...
	Master je osadený na nRFGo MotherBoard doske a je pripojený k LED diódam a tlačidlám. 
...
\section{Bootloader} \label{bootloader}
	Na Master zariadení, ktoré je osadené na vývojovej doske nRF6310 (nRF Go MotherBoard), je možné ihneď po zapnutí, pri podržaní ktoréhokoľvek tlačidla, nakonfigurovať zabezpečenie bezdrôtového komunikačného kanála. Následne umožňuje aj zapnutie automatického testu a prejdenie do testovacieho módu na odladenie komunikácie cez štandard ISO7816.
Pre namapovanie týchto funkcií na príslušné tlačidlá pozri obr. \ref{f:o_bootloader}.
...
\section{Štandard ISO7816}
	...
	Implementované rozhranie dokáže komunikovať iba s protokolom, ktorý je kódovaný v priamej konverzii. Typ konverzie sa zisťuje z prvého bajtu ATR správy. Jedná sa o bajt označovaný ako \quotes{TS}. Slúži aj ako synchronizačná sekvencia. Hodnoty bajtu TS nadobúdajú dve hodnoty:
	%\singlespacing	
	\begin{itemize}
	...
	Program generuje sekvenciu studenej aktivácie karty a deaktivácie karty. Po úspešnom pripojení a aktivačnej sekvencii, karta odpovie správou ATR. To je jediný prípad, kedy karta posiela správu. Smart karta od tejto chvíle čaká správu od terminálu. Komunikácia prebieha vo dvojiciach príkaz-odpoveď.
	...
	Generovanie hodinového signálu je realizované procesorom. Generovanie signálu prebieha automatizovane, čisto prostredníctvom hardvéru. Softvér slúži v tomto prípade iba na nainicializovanie periférií. Toto je možné dosiahnuť pomocou časovača Timer2 v 8 bitovom režime, udalostí, úlohy a periférie s názvom PPI (Programmable Peripheral Interface), ktorá poprepájala jednotlivé bloky. Pomocou týchto periférií bolo možné vygenerovať pri frekvencii oscilátora 16MHz, hodinový signál s frekvenciou maximálne 4MHz. Výsledný pracovný cyklus hodín je 50\%. Vo výslednej implementácií je frekvencia externého hodinového signálu CLK 2666666.7 Hz.
...
Každá prijatá hodnota sa zobrazí na ôsmich LED diódách.
...
Jednotlivé verzie projektov, históriu, poprípade ich novšie verzie je možné nájsť aj na repozitáry \url{https://github.com/pauksk/nrf6310-pca10007}.
 ...
 \begin{figure*}[!htb]
 	\centering
 	\includegraphics[scale=0.5]{keil_flash.jpg}
...
\section{Skompilovanie appletu} \label{s_applet_compile}
	...
	\begin{figure*}[!htb]
		\centering
		\includegraphics[scale=0.5]{Java_card_compile.jpg}
...
\section{Inštalácia appletu} \label{s_applet_install}
	...
	\begin{figure*}[h]
		\centering
		\includegraphics[scale=0.5]{krypto_reader2.jpg}
...
\subsection{PyApduTool} \label{s_applet_pytool}
	...
	\begin{figure*}[h]
		\centering
		\includegraphics[scale=0.5]{applet_install1.jpg}
		\caption{Pripojenie čítačky kariet.}
		\label{f:applet_install1}
	\end{figure*}
	\begin{figure*}[h]
		\centering
		\includegraphics[scale=0.5]{applet_install2.jpg}
...
\begin{figure*}[h]
	\centering
	\includegraphics[scale=0.5]{board1_.jpg}
...
\begin{figure*}[h]
	\centering
	\includegraphics[scale=0.5]{board2_.jpg}
...
\begin{figure*}[h]
	\centering
	\includegraphics[scale=0.5]{board2_con.jpg}
...
\begin{figure*}[h]
	\centering
	\includegraphics[scale=0.6]{i_converter.jpg}
