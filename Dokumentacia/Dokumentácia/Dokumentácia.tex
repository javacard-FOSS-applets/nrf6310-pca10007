...
\begin{itemize}
	...
	\item RW (Read/write): identifikuje, koľko je v skompilovanom programe nainicializovaných premenných, nachádzajúcich sa RAM,
	\item ZI (Zero initialized): identifikuje, koľko sa nachádza v kóde nenainicializovaných premenných, nachádzajúcich sa RAM pamäti,
