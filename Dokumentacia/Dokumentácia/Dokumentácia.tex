...
\begin{figure*}[h]
	\centering
	\includegraphics[scale=1]{test2.png}
...
\chapter{Technický manuál} \label{s_manual}
 ...
 \begin{enumerate}
 	\item keil,
 	\item arm-amd,
 	\item doinstalovat balíčky,
 	\item otvorit projekt,
 	\item je predkonfigurovane,
 	\item vyberte target,
 	\item pripojte segger jlink k doske,
 	\item pripojte napajanie k odkse,
 	\item nahrajte skompilovany program na dosku.
 \end{enumerate}
...
\section{Skompilovanie appletu} \label{s_applet_compile}
	...
	\begin{figure*}[h]
		\centering
		\includegraphics[scale=0.3]{Java_card_compile.jpg}
...
\section{Inštalácia appletu} \label{s_applet_install}
	...
	\begin{figure*}[h]
		\centering
		\includegraphics[scale=0.3]{applet_install1.jpg}
		\caption{}
		\label{f:applet_install1}
	\end{figure*}
	\begin{figure*}[h]
		\centering
		\includegraphics[scale=0.3]{applet_install2.jpg}
		\caption{}
