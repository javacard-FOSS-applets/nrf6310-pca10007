...
\section{Štandard ISO7816}
	...
	Implementované rozhranie dokáže komunikovať iba s protokolom, ktorý je kódovaný v priamej konverzií. Identifikácia konverzie prebieha z prvého bajtu ATR správy. Jedná sa o bajt označovaný ako \quotes{TS}. Jeho hodnoty následovné znamenajú nasledovné. Slúžia aj ako synchronizačné sekvencie:
	\begin{itemize}
