...
\section{Štandard ISO7816}
	...
	Implementované rozhranie dokáže komunikovať iba s protokolom, ktorý je kódovaný v priamej konverzií. Identifikácia konverzie prebieha z prvého bajtu ATR správy. Jedná sa o bajt označovaný ako "TS". Jeho hodnoty následovné znamenajú nasledovné. Slúžia aj ako synchronizačné sekvencie:
	\begin{itemize}
		\item 0x3B: jedná sa o priamu konverziu,
		\item 0x3F: jedná sa o inverznú konverziu.
	\end{itemize}
	...
	Pri štandardných parametroch označovaných ako "Clock rate conversion factor" = 372 a "Bit rate adjustment factor" = 1, sa výsledná rýchlosť sériovej linky rovná 2666666.7/372 = 7168 bps.
...
\section{Applet}
	...
	Po nahratí, nainštalovaní a vybratí appletu je applet pripravený na použitie. Applet odpovedá na správy v dátovej časti APDU následovne. Na parametroch APDU správy ako inštrukcia, parametre P1 a P2 nezáleží, neberú sa do úvahy.
	\begin{itemize}
		...
		\item 0x48 odpovie naspäť text "ALOHA",
